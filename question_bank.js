window.QUESTION_BANK = {
  "meta": {
    ...
    "updated": "2026-07-30",
    "question_count": 325,
    "notes": "v5.11.1 re-audits all 91 user-imported questions against the March 2026 exam guide and current official Databricks documentation; 29 ambiguous, stale, incomplete, or incorrect imported items were corrected or reframed.",
    "sources": [
    ...
    "description": "v5.11.1: full user-imported question re-audit, corrected answer logic, repaired missing context, updated Databricks terminology, and concise option-specific explanations."
  },
  "questions": [
    {
