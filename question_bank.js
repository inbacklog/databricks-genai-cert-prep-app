window.QUESTION_BANK = {
  "meta": {
    ...
    "updated": "2026-07-09",
    "question_count": 285,
    "notes": "Strict rewrite pass part 3 reviewed the remaining generated-practice bank, removed one app-meta question, cleaned remaining generic explanations, and recalibrated difficulty labels. User-imported questions were left unchanged.",
    "sources": [
    ...
    "description": "v5.2 strict rewrite pass part 3: remaining generated-practice items reviewed for realistic distractors and targeted per-option explanations; user-imported questions left unchanged."
  },
  "questions": [
    {
      ...
      "options": [
        {
          ...
          "explanation": "Correct. Tracing is designed to show the execution path of multi-step GenAI applications. Example: you can see the LLM selected search_orders, what arguments it passed, and what the tool returned."
        },
        {
          "id": "B",
          "text": "Only aggregate accuracy over a static test set.",
          "explanation": "Incorrect. Accuracy evaluation is useful, but it does not show the step-by-step runtime path. Example: a score of 72% does not show which tool call failed."
        },
        {
          "id": "C",
          "text": "Only endpoint infrastructure metrics such as CPU or GPU utilization.",
          "explanation": "Incorrect. Infrastructure metrics show resource pressure, not agent reasoning/tool flow. Example: CPU at 80% does not reveal that the wrong tool was called."
        },
        {
          "id": "D",
          "text": "Only source-code line coverage.",
          "explanation": "Incorrect. Code coverage is a software-testing metric, not GenAI trace observability. Example: 90% test coverage does not show prompt/tool inputs for one failed user run."
        }
      ],
      "correct_answers": [
        "A"
      ],
      "explanation": "MLflow tracing is for observing the internal execution flow of LLM/agent applications, not just aggregate metrics.",
      "source_links": [
        "https://docs.databricks.com/aws/en/mlflow3/genai/tracing",
        "https://docs.databricks.com/aws/en/mlflow3/genai/eval-monitor/evaluate-app",
        "https://docs.databricks.com/aws/en/mlflow3/genai/eval-monitor/concepts/scorers",
    ...
    },
    {
      ...
      "options": [
        ...
        {
          "id": "B",
          "text": "Only the model’s download count or popularity ranking.",
        ...
        {
          "id": "D",
          "text": "Only whether the model has a polished demo.",
    ...
    },
    {
      ...
      "options": [
        ...
        {
          "id": "D",
          "text": "Only CPU models are supported.",
    ...
    },
    {
      ...
      "options": [
        ...
        {
          "id": "B",
          "text": "Only add a final output filter and keep the toxic corpus unchanged",
    ...
    },
    {
      ...
      "options": [
        ...
        },
        {
          ...
          "explanation": "Partially relevant, but less complete than A. If the prompt says “explain your reasoning,” removing it helps, but examples plus constraints are stronger. Example: “Return only the summary” reduces extra prose."
        },
        {
          "id": "C",
    ...
    },
    {
      ...
      "options": [
        ...
        {
          "id": "B",
          "text": "Only filename metadata, such as policy_final_v3.pdf.",
        ...
        {
          "id": "C",
          "text": "Only embedding similarity with no metadata filters.",
    ...
    },
    {
      ...
      "options": [
        ...
        {
          "id": "D",
          "text": "Only an embedding vector for each feedback item",
    ...
    },
    {
      ...
      "options": [
        ...
        {
          "id": "B",
          "text": "Only register a model in Unity Catalog",
        ...
        {
          "id": "C",
          "text": "Only create an AI Search index",
        ...
        {
          "id": "D",
          "text": "Only run a notebook cell for each employee request",
    ...
    },
    {
      ...
      "options": [
        ...
        {
          "id": "B",
          "text": "Only the initial offline benchmark score from before the weekly ingestion process started.",
        ...
        {
          "id": "C",
          "text": "Only endpoint latency and request volume.",
        ...
        {
          "id": "D",
          "text": "Only the number of documents added each week.",
      ...
      "options": [
        {
          ...
          "explanation": "Correct. “Never mention internal system names” is a business/style policy that needs a custom rule or guidelines-based evaluation. Example: fail answers containing “internal_table_123”."
        },
        {
          "id": "B",
          "text": "Context recall",
          "explanation": "Incorrect. Context recall checks whether retrieval found the needed evidence, not whether the final wording follows a style rule. Example: the right chunks can be retrieved while the answer still mentions an internal system."
        },
        {
          "id": "C",
          "text": "Token usage monitoring only",
          "explanation": "Incorrect. Token usage tracks cost/volume, not policy compliance. Example: a cheap answer can still violate the style rule."
        },
        {
          "id": "D",
          "text": "Embedding dimension",
          "explanation": "Incorrect. Embedding dimension affects vector representation and retrieval cost/quality, not final response wording. Example: 768 vs 1,024 dimensions does not check forbidden terms."
        }
      ],
      "correct_answers": [
        "A"
      ],
      "explanation": "Custom policies often need custom scorers, even when built-in quality metrics are available.",
      "source_links": [
        "https://docs.databricks.com/aws/en/mlflow3/genai/eval-monitor/concepts/judges/",
        "https://docs.databricks.com/aws/en/mlflow3/genai/eval-monitor/concepts/scorers",
        "https://docs.databricks.com/aws/en/mlflow3/genai/eval-monitor/evaluate-app",
    ...
    },
    {
      ...
      "options": [
        ...
        {
          "id": "B",
          "text": "Only a larger max_tokens value.",
    ...
    },
    {
      ...
      "options": [
        ...
        {
          "id": "C",
          "text": "Only the model temperature used during answer generation.",
    ...
    },
    {
      ...
      "options": [
        ...
        {
          "id": "D",
          "text": "Only model-card license metadata.",
